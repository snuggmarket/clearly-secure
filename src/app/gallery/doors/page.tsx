...
export default function DoorsGallery() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 pt-24 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-20 text-center pt-[75px]">
        ...
        >
          Explore some of our recent door installations across Hampshire. High-security, premium aesthetics, and professional craftsmanship.
        </motion.p>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black/60 to-transparent flex justify-center">
                 <p className="text-white/80 text-sm font-light tracking-wide uppercase">Clearly Secure Doors - Hampshire's Finest</p>
              </div>
            </motion.div>
          </motion.div>
        )}
